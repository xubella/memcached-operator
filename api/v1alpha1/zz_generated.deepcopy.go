...
func (in *MemcachedStatus) DeepCopyInto(out *MemcachedStatus) {
	*out = *in
	...
	in.Status.DeepCopyInto(&out.Status)
	in.MemcachedStatusFields.DeepCopyInto(&out.MemcachedStatusFields)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemcachedStatusFields) DeepCopyInto(out *MemcachedStatusFields) {
	*out = *in
	if in.StartTime != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemcachedStatusFields.
func (in *MemcachedStatusFields) DeepCopy() *MemcachedStatusFields {
	if in == nil {
		return nil
	}
	out := new(MemcachedStatusFields)
	in.DeepCopyInto(out)
	return out
}
